...
namespace Illuminate\Support\Facades { 
    ...
    class Queue {
        ...
        {
            return \Illuminate\Queue\NullQueue::size($queue);
        }
        ...
        {
            return \Illuminate\Queue\NullQueue::push($job, $data, $queue);
        }
        ...
        {
            return \Illuminate\Queue\NullQueue::pushRaw($payload, $queue, $options);
        }
        ...
        {
            return \Illuminate\Queue\NullQueue::later($delay, $job, $data, $queue);
        }
        ...
        {
            return \Illuminate\Queue\NullQueue::pop($queue);
        }
        ...
        public static function pushOn($queue, $job, $data = '')
        {
            ...
            return \Illuminate\Queue\NullQueue::pushOn($queue, $job, $data);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Illuminate\Queue\NullQueue::laterOn($queue, $delay, $job, $data);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Illuminate\Queue\NullQueue::bulk($jobs, $data, $queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Illuminate\Queue\NullQueue::getConnectionName();
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Illuminate\Queue\NullQueue::setConnectionName($name);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            \Illuminate\Queue\NullQueue::setContainer($container);
        }
